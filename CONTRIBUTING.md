# Contributing to Foundry Compilers

:balloon: Thanks for your help improving the project! We are so happy to have
you!

There are opportunities to contribute to Foundry Compilers at any level. It doesn't
...
[dev]: https://t.me/foundry_rs

## Conduct

The Foundry Compilers project adheres to the [Rust Code of Conduct][coc]. This describes
...
[enrique@ortiz](mailto:hi@enriqueortiz.dev).
...
1. By opening the issue for discussion: For instance, if you believe that you
   have uncovered a bug in Foundry Compilers, creating a new issue in the Foundry Compilers
...
3. By helping to resolve the issue: Typically this is done either in the form of
   ...
   Foundry Compilers in a concrete and reviewable manner.
...
When opening a new issue in the Foundry Compilers issue tracker, users will be presented
...
cases should be limited, as much as possible, to using only Foundry Compilers APIs.
...
functional guidelines of the Foundry Compilers project.

## Pull Requests

Pull Requests are the way concrete changes are made to the code, documentation,
and dependencies in the Foundry Compilers repository.
...
Foundry Compilers maintains strict standards for code quality and style, as well as
...
example), it is either adding new functionality to Foundry Compilers or it is fixing
existing, broken functionality. In both of these cases, the pull request should
include one or more tests to ensure that Foundry Compilers does not regress in the
future.
...
**Any Foundry Compilers community member is welcome to review any pull request**.

All Foundry Compilers contributors who choose to review and provide feedback on Pull
...
1. Does this change make sense for Foundry Compilers?
2. Does this change make Foundry Compilers better, even if only incrementally?
...
Foundry Compilers Collaborator landing the Pull Request but they can also be an
...
a particular change that makes Foundry Compilers better, but the individual might just
not want to have anything to do with Foundry Compilers ever again. The goal is not just
having good code.
