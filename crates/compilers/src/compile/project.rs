...
type CompilationResult<I, E, C> = Result<Vec<(I, CompilerOutput<E, C>, Vec<PathBuf>)>>;
...
) -> CompilationResult<C::Input, C::CompilationError, C::CompilerContract> {
    jobs.into_iter()
